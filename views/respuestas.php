...
<body>
    ...
    <main class="container mx-auto">
        ...
        ?>
            <form class="flex bg-slate-100 container my-8 p-5" action="http://localhost/GestionDeClientesPHP/ticket/responderTicket?ticketId=<?php echo $value['ticket_id']."&equipoId=5&tipo=".$value['categoria'].""?>" method="POST">
